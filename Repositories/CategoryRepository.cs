            ...
            return new List<Category>
             {
                 ...
                 new Category {Title = "Ordenadores", Id = 1000, ImageUri = new Uri(ImageServerPath + "ordenadores.jpg", UriKind.Absolute) },
                 new Category { Title = "Personales", Id=1, ParentId=1000, ImageUri = new Uri(ImageServerPath + "Ordenadores1.jpg", UriKind.Absolute) },
                 new Category { Title = "Portatiles", Id=2, ParentId=1000, ImageUri = new Uri(ImageServerPath + "Ordenadores2.jpg", UriKind.Absolute) },
                 
                 
                 new Category {Title = "Informática", Id = 2000, ImageUri = new Uri(ImageServerPath + "Informatica.jpg", UriKind.Absolute) },
                 
                 new Category {Title = "Telefonía", Id = 3000, ImageUri = new Uri(ImageServerPath + "telefonia.jpg", UriKind.Absolute) },
                 new Category {Title = "Imagen y Sonido", Id = 4000, ImageUri = new Uri(ImageServerPath + "ImagenySonido.jpg", UriKind.Absolute) },
                 new Category {Title = "Juegos y Consolas", Id = 5000, ImageUri = new Uri(ImageServerPath + "JuegosyConsolas.jpg", UriKind.Absolute) },
                 new Category { Title = "Lavadoras", Id=6000, ImageUri = new Uri(ImageServerPath + "Lavadoras.jpg", UriKind.Absolute) },
                 new Category { Title = "Fotografía", Id=7000, ImageUri = new Uri(ImageServerPath + "Fotografía.jpg", UriKind.Absolute) },
                 new Category { Title = "Electrodomesticos", Id=8000, ImageUri = new Uri(ImageServerPath + "electrodomesticos.jpg", UriKind.Absolute) },
